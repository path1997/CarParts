...
public class URLs {
    ...
    //------------------------------------------------PRODUCT-----------------------------------------------------
    public static final String URL_CATEGORY= "http://carparts.5v.pl/android/products.php?apicall=category";
    public static final String URL_PRODUCTLIST= "http://carparts.5v.pl/android/products.php?apicall=productlist";
    public static final String URL_PRODUCTLISTFORHOME= "http://carparts.5v.pl/android/products.php?apicall=productlistforhome";
    public static final String URL_PRODUCTDETAIL= "http://carparts.5v.pl/android/products.php?apicall=productdetail";
